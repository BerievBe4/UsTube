...
CREATE TABLE `commentlike` (
  ...
  CONSTRAINT `commentlike_ibfk_1` FOREIGN KEY (`UserId`) REFERENCES `usermodel` (`Id`),
  CONSTRAINT `commentlike_ibfk_2` FOREIGN KEY (`CommentId`) REFERENCES `usercomment` (`Id`) ON DELETE CASCADE
...
INSERT INTO `commentlike` VALUES (11,1,32);

...
CREATE TABLE `videolike` (
  ...
  KEY `UserId` (`UserId`),
  KEY `VideoId` (`VideoId`),
  CONSTRAINT `videolike_ibfk_1` FOREIGN KEY (`UserId`) REFERENCES `usermodel` (`Id`),
  CONSTRAINT `videolike_ibfk_2` FOREIGN KEY (`VideoId`) REFERENCES `videofile` (`Id`) ON DELETE CASCADE
